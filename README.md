...
git clone https://github.com/DanYuOmics/BALL_Cohort.git
cd BALL_Cohort

**Step 2: Create and activate a conda environment for R and dependencies**
conda create -n ball_omics r-base=4.3.3 python=3.10 -y
conda activate ball_omics

**Step 3: Install required R packages**
R -e 'install.packages(c("tidyverse", "survival", "survminer", "timeROC", "pheatmap", "openxlsx", "cowplot", "BiocManager"), repos="https://cloud.r-project.org")'
